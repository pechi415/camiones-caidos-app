...
## Control de Camiones en Campo
**Operaciones:** Mina Pribbenow & Mina El Descanso • Drummond Ltd. Colombia  
**Versión del Documento:** 1.0 — Guía Práctica para Registro, Monitoreo de DOWN y Cierre de Turno en Operaciones Mineras
...
Permite centralizar la información operativa para que el personal de producción tome decisiones con datos confiables:
...
- Resaltar los equipos que quedan caídos en Pit y rampas arrastrados de turnos anteriores.
...
3. **Operador (Obligatorio):** Seleccione el operador en la lista inteligente.
...
- **Línea de Tiempo:** Muestra cada DOWN que ha tenido el camión, con fecha, operador y componente dañado. Alerta sobre el **Sistema más recurrente** (detección de fallas crónicas).
- Permite descargar la hoja de vida de la unidad en PDF.

---

## 9. GESTIÓN DE OPERADORES (ADMIN)
- Directorio de operadores de acarreo.
...
- En Pit minero sin señal, la aplicación mantiene la consulta de datos en memoria y revalida la sesión automáticamente al recuperar conexión.

---

## 13. CIERRE DE SESIÓN Y SEGURIDAD
- Haga clic en su foto o nombre en la esquina superior derecha y elija **"Cerrar Sesión"**.
- Obligatorio en computadores compartidos de supervisión.
...
- **Oportunidad:** Registre las caídas inmediatamente ocurran para evitar desfases en los tiempos de parada.
- **Precisión:** Confirme que el operador seleccionado corresponda al operador real del camión.
- **Seguridad:** No comparta su clave personal con otros compañeros de turno.
- **Cierre de Turno:** Descargue el informe PDF al finalizar la jornada antes del cambio de guardia.
